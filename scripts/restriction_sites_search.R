...
# Configura o arquivo de output e os sítios de restrição
#(qualquer sequência na verdade) que serão buscados ao longo do genoma

# Arquivo com os sítios em formato fasta
...
# Writes the bed file contining the restriction sites.
